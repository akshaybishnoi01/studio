...
const Newsletter = () => {
  return (
    <div className='bg-black mt-[-2px] relative pt-7'>
      ...
      <img className='lg:max-w-[510px] pointer-events-none max-w-[460px] w-full absolute z-0 bottom-[0%] xl:left-[33%] md:left-[26%] sm:left-[18%] left-[0%]' src={news_bg} alt="#" />
