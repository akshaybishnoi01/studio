                ...
                <div className='sm:max-w-[576px] md:max-w-[768px] lg:max-w-[1041px] mx-auto'>
                    <Slider {...settings2}>
                        ...
                        <div className='bg-clients_cardbg bg-no-repeat bg-full lg:p-[40px_60px] sm:p-[40px_30px] p-[40px_12px] min-h-[411px] mx-auto max-w-[576px] md:max-w-[768px] lg:max-w-[1041px] w-full '>
                            <div className='flex lg:flex-row flex-wrap -mx-3'>
                                <div className='lg:w-8/12 w-full px-3'>
                                    <h3 className='after:content-[""] lg:text-start lg:inline-block after:absolute lg:after:bg-clients_topborder after:bg-no-repeat after:bg-full md:after:top-[-1%] sm:after:top-[-4%] after:top-[-12%] after:left-[-6%]  after:w-[300px] after:h-[21px]  before:content-[""] before:absolute lg:before:bg-clients_bottoborder before:bg-no-repeat before:bg-full before:w-[300px] before:h-[21px] md:before:bottom-[-5%] sm:before:bottom-[-10%] before:bottom-[-30%] md:before:right-[-9%] before:right-[-6%] relative font-bold md:text-custom-42 sm:text-4xl text-custom-32 text-center md:leading-[54px] sm:leading-10 leading-8 font-orbitron text-white'>
                                        Dino Island
                                    </h3>
                                    <div className='flex flex-col lg:items-start items-center'>
                                        <p className='font-poppins lg:text-start text-center md:text-2xl sm:text-xl text-base lg:leading-9 leading-7 font-normal text-white opacity-70 max-w-[621px] pt-5'>
                        ...
                        <div className='bg-clients_cardbg bg-no-repeat bg-full lg:p-[40px_60px] sm:p-[40px_30px] p-[40px_12px] min-h-[411px] mx-auto max-w-[576px] md:max-w-[768px] lg:max-w-[1041px] w-full '>
                            <div className='flex lg:flex-row flex-wrap -mx-3'>
                                <div className='lg:w-8/12 w-full px-3'>
                                    <h3 className='after:content-[""] lg:text-start lg:inline-block after:absolute lg:after:bg-clients_topborder after:bg-no-repeat after:bg-full md:after:top-[-1%] sm:after:top-[-4%] after:top-[-12%] after:left-[-6%] after:w-[300px] after:h-[21px]  before:content-[""] before:absolute lg:before:bg-clients_bottoborder before:bg-no-repeat before:bg-full before:w-[300px] before:h-[21px] md:before:bottom-[-5%] sm:before:bottom-[-10%] before:bottom-[-30%] before:right-[-6%] relative font-bold md:text-custom-42 sm:text-4xl text-custom-32 text-center md:leading-[54px] sm:leading-10 leading-8 font-orbitron text-white'>
                                        Lava Land
                                    </h3>
                                    <div className='flex flex-col lg:items-start items-center'>
                                        <p className='font-poppins lg:text-start text-center md:text-2xl sm:text-xl text-base lg:leading-9 leading-7 font-normal text-white opacity-70 max-w-[621px] pt-5'>
